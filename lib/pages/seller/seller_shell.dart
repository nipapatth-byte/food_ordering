      ...
      bottomNavigationBar: SafeArea(
        ...
        child: Container(
          ...
          child: GNav(
            ...
            tabs: const [
              GButton(icon: Icons.receipt_outlined, text: 'ออเดอร์'),
              GButton(icon: Icons.restaurant_menu_outlined, text: 'เมนู'),
              GButton(icon: Icons.table_bar_outlined, text: 'โต๊ะ'),
              GButton(icon: Icons.bar_chart_outlined, text: 'รายงาน'),
